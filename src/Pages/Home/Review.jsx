      ...
      <div className="grid gap-6 text-center md:grid-cols-3 lg:gap-12">
        ...
        <div className="mb-12 md:mb-0">
          ...
          <p className="mb-4">
            ...
            Very Good Shop.I ordered a Car and The Delivery was so quick
          </p>
        ...
        <div className="mb-12 md:mb-0">
          ...
          <p className="mb-4">
            ...
            Highly Recomanded To everyOne.If You want a good toy for your
            kid,this is right place to look for
          </p>
          <ul className="mb-0 flex items-center justify-center">
            <li>
              <svg
        ...
        <div className="mb-12 md:mb-0">
          ...
          <p className="mb-4">
            ...
            I wanted some toys for my kib.So i ordered some toy from then.And i
            dont regret my desition.
          </p>
          <ul className="mb-0 flex items-center justify-center">
            <li>
              <svg
