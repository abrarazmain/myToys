      ...
      <div className="container my-24 px-6 mx-auto mt-20">
        ...
        <section className="mb-32 text-gray-800">
          ...
          <div className="flex flex-wrap">
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-[#65C3C8] focus:outline-none"
                    id="exampleInput7"
                    placeholder="Name"
                  />
                </div>
                ...
                <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div className="flex items-start">
                    <div className="shrink-0">
                      <div className="p-4 bg-[#65C3C8]  rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                        <svg
                          aria-hidden="true"
                          focusable="false"
                          data-prefix="fas"
